 ...
 * [wbbt.yml](wbbt.yml)
     * Determines how your purl.obolibrary.org/obo/wbbt/ redirects will be handled
     ...
     * Paste in the contents of [wbbt.yml](wbbt.yml)
 ...
 * [wbbt.md](wbbt.md)
     ...
     * Paste in the contents of [wbbt.md](wbbt.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
